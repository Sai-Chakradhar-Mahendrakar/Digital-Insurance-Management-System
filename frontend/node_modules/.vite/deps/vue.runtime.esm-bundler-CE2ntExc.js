...
const hydrateOnIdle = (timeout = 1e4) => (hydrate$1) => {
...
const hydrateOnVisible = (opts) => (hydrate$1, forEach) => {
...
const hydrateOnMediaQuery = (query) => (hydrate$1) => {
	if (query) {
...
const hydrateOnInteraction = (interactions = []) => (hydrate$1, forEach) => {
...
//# sourceMappingURL=vue.runtime.esm-bundler-CE2ntExc.js.map